...
public class ReportAnnoGridViewAdapter extends ArrayAdapter<ListaReportAnno> {
    private final ArrayList<ListaReportAnno> myLista;
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (item != null) {
            ...
            if (myListaEntrata != null) {
                myListaEntrata.setText(df.format(item.getListaEntrata()));
                myListaEntrata.setTextSize(12);
            }

            if (myListaUscita != null) {
                myListaUscita.setText(df.format(item.getListaUscita()));
